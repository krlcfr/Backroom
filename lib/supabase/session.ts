...
export async function updateSession(request: NextRequest) {
  ...
  const isProtectedRoute = url.pathname.startsWith('/dashboard') || url.pathname.startsWith('/org') || url.pathname.startsWith('/admin') || url.pathname.startsWith('/demo/backroom') || url.pathname.startsWith('/demo/limites')
