...
export const metadata: Metadata = { title: "Configuraci髇" };
...
export default async function ConfiguracionPage() {
  ...
  if (!org) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
        ...
        <h2 className="text-[20px] font-semibold text-[#e2e2e2] mb-2">Sin organizaci贸n</h2>
        <p className="text-[#ccc3d8] max-w-md mb-6">
          A煤n no perteneces a una organizaci贸n. Crea una para configurar su perfil.
        </p>
        <Link
          href="/org/crear"
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-headline-lg font-semibold text-[#e2e2e2] mb-2">Configuraci贸n de Organizaci贸n</h1>
      ...
      {!esPropietario ? (
        <div className="rounded-xl border border-[#4a4455] bg-[#1e2020] p-8 text-center">
          ...
          <p className="text-[14px] text-[#ffb4ab]">
            Solo el Propietario puede configurar la organizaci贸n.
          </p>
        </div>
      ) : (
        <ConfiguracionForm
