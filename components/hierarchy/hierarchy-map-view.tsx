...
export interface HierarchyMapViewProps {
  tree: RoomNode[]
  backroomId: string
  backroomName: string
  activeRoomId?: string
...
export default function HierarchyMapView({ tree, backroomId, backroomName, activeRoomId, auditMode, userPermissions, onNodeAuditClick }: HierarchyMapViewProps) {
  ...
  }, [router, backroomId, auditMode, onNodeAuditClick])

  return (
    <div className="w-full h-full bg-[#1e2020] border border-[#3f3f46] rounded-2xl shadow-xl overflow-hidden flex flex-col relative">
      <div className="absolute top-6 left-6 z-10">
        ...
        <p className="text-[#ccc3d8] text-sm mt-1">Explora la jerarquía de {backroomName}</p>
      </div>
